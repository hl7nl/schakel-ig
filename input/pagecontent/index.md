...
The initial version of SCHAKEL starts with a concrete elaboration of the use case for information exchange between out‑of‑hours primary care (HAP) and long‑term care (VVT). This use case serves as a practical starting point to demonstrate how SCHAKEL principles are applied and how the defined building blocks can be implemented in practice.
...
All artefacts defined in SCHAKEL are developed in line with these principles. They provide context for the modelling choices made throughout the guide and serve as a stable reference for authors, reviewers, and implementers.

For a full overview, see the [Principles and commitments](principles_commitments.html) page.
